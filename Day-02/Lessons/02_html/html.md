...
- Write an HTML document that represents your own personal blog using HTML. Focus on structure and include some sample content. Include attributes such as class and id, but do not worry about writing any styling.
